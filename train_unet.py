...
data_dicts = []
with open("./public_data/file_works.txt", "r") as f:
    for line in f:
        line = line.strip()
        dic = eval(line) #eval is a nice
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        with torch.no_grad():
            ...
            if metric > best_metric:
                ...
                torch.save(model.state_dict(), os.path.join(root_dir, "ran_ts_aapm_amos_btcv_best_metric_model.pth"))
                print("saved new best metric model")
                logging.info(f"ran_ts_aapm_amos_btcv_80_20best_metric_model.pth at epoch:{epoch} with dice score of {best_metric: .4f}")
            print(
...
# 12 min per epoch batchsize 4, gpu 5 gb